...
<Filter handelClick={isChecked=> this.setState({
 ...
 <Col>
 <Rate rating={(R)=>this.ratingSearch(R)} />
 ...
 {}
  <MovieList movies={(this.state.searchTerm ==='')? (this.dynamicRating(this.movies) || this.dynamicSearch(this.movies)): (this.dynamicRating(this.movies)&&this.dynamicSearch(this.movies))} />
  </Col>
  <Col>
 </Col>
  </Row>
